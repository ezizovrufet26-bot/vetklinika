...
import { Crown, Check, X, Building2, User, Phone, ShieldCheck, Clock, Sparkles } from 'lucide-react'
...
export default function SuperAdminPanel() {
  ...
  const loadRequests = () => {
    ...
    if (json) {
      ...
      // Seed default demo request if empty for demonstration
  ...
  const handleApprove = (req: AccessRequest) => {
    ...
    // Automatically provision new clean clinic workspace!
            ...
            <div className="flex items-center gap-4 border-b border-slate-800 pb-4">
              ...
              <div>
                <h3 className="text-2xl font-black text-white flex items-center gap-2">
                  SuperAdmin İdarəət Mərkəzi
                </h3>
                <p className="text-xs text-slate-400 font-medium">Reklamdan gələn müştərilərin qeydiyyat təsdiqləri və giriş icazələri</p>
              </div>
            </div>
